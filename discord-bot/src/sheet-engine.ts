// ---------------------------------------------------------------------------
// MIRROR COPY for the standalone bot process (2026-08-06). The authoritative
// source is the website's src/lib/sheet-engine.ts - this file must stay a
// byte-identical copy below this header block (the bot can't import Next.js
// modules; same deliberate duplication trade-off as db.ts vs discord-io.ts).
// When the website engine changes, re-copy it here in the same commit.
// ---------------------------------------------------------------------------
// ---------------------------------------------------------------------------
